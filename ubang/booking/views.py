...
class BookingView(ModelViewSet):
    ...
    search_fields = ('bookingId', 'confirmId', 'contact_name', 'contact_phone', 'create_by__name', 'create_by__username', 'vehicle__traffic_plate_no', 'guide__name', 'guide__username',)
    ordering = ('-id',)
