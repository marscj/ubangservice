...
class CustomerUserAdmin(UserAdmin):
    ...
    list_display = ('username', 'company', 'full_name', 'is_driver', 'is_tourguide', 'phone', 'email', 'wechart', 'gender', 'is_staff', 'is_superuser')
    list_filter = ('company', 'gender', 'is_driver', 'is_tourguide', 'is_staff', 'is_active')
    search_fields = ('username', 'full_name', 'phone', 'email', 'wechart')
