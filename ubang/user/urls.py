...
urlpatterns = [
    ...
    url(r'login', views.LoginJwtTokenView.as_view(), name='login'),     # jwt的认证接口（较之drf自带的认证模式，占用的服务器端资源更少，安全性更高）
    url(r'logout', views.LogoutJwtTokenView.as_view(), name='logout'),
]
