    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechart', models.CharField(blank=True, max_length=64, null=True)),
                ('whatsup', models.CharField(blank=True, max_length=64, null=True)),
            ...
            managers=[
                ('objects', ubang.user.models.CustomUserQuerySet()),
            ],
        ),
    ]
